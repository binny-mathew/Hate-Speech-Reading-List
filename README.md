...
### :tada: :tada: We are making a more advance reading list for hate speech papers [here](https://www.notion.so/punyajoy/Hate-speech-papers-resource-7fc20fa1bea64cbdb30862092ae197b3). Please checkout and provide feedback 
...
### <a name='langEng'> English
  #### 2020
  * Chris J. Kennedy, Geoff Bacon, Alexander Sahn, Claudia von Vacano. [Constructing interval variables via faceted Rasch measurement and multitask deep learning: a hate speech application](https://arxiv.org/abs/2009.10277). 2020. *arXiv*
 ...
 *  Sylvia Jaki, and Tom De Smedt. [Right-wing German hate speech on Twitter: Analysis and automatic detection](https://arxiv.org/abs/1910.07518). 2019. *arXiv*
